...
export default function LocationCard({
  ...
  return (
    <div className="flex flex-col justify-between gap-4 rounded-lg border border-zinc-200 bg-white py-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <div className="flex flex-col  gap-2">
        <div className="flex flex-col gap-2 px-4">
          <div className="flex flex-row justify-between gap-4 text-zinc-950 dark:text-white ">
            <h3 className="font-semibold">{location.name}</h3>
            <div className="flex flex-row gap-1">
              <h5 className="pt-[1px] font-medium">{location.rating}</h5>
              <svg
                width="24"
                height="24"
                viewBox="0 0 16 16"
