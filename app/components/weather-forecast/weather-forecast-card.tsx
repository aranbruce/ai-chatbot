  ...
  return (
    <>
      ...
      <div className="flex flex-row gap-2 items-center">
        <button className="flex flex-row gap-2 items-center text-sm text-zinc-600 px-2 py-1 bg-zinc-100 rounded-xl w-fit border border-zinc-200/50" onClick={() => handleGetCurrentWeather(weatherForecast.location, weatherForecast.daily[0].units)}>
