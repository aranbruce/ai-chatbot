...
const UploadButton = () => {
  ...
  return (
    <div className={`display flex flex-wrap gap-1 items-start ${filesAsInput.length > 0 ? "p-2" : ""}`}>
      ...
      <button type="button" aria-label="attach file" className="flex bg-white dark:bg-zinc-800 rounded-full border border-zinc-200 dark:border-zinc-800 p-[0.375rem] items-center h-fit bottom-[0.75rem] left-[0.75rem] absolute text-zinc-900 dark:text-zinc-50 focus:outline-none focus-visible:ring-[2px] ring-zinc-400 dark:ring-zinc-400" onClick={() => handleAddFileButtonClick()}>
