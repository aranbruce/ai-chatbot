      ...
      (
        <div key={id} className="messages whitespace-pre-wrap flex flex-row gap-3 items-start last:pb-28">
          ...
          <div className="flex gap-2 flex-col max-w-full">
            <h5 className="text-md text-zinc-950 dark:text-zinc-300 font-medium pt-1">{role === "user" ? "You" : "Chatbot"}</h5>
            {data && data.file && (
              <div className="flex flex-row gap-2 items-center border p-3 rounded-lg">
                <div className="bg-zinc-800 rounded-full p-2 text-zinc-50 border border-zinc-200">
                ...
                <div className="font-medium text-sm">{data.file.fileName}</div>
              </div>
            )}
